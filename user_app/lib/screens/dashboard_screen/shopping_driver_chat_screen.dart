...
class DriverMessageSendScreen extends StatefulWidget {
  final FirebaseUser11Model userModel;
  final DriverModel driverModel;
  const DriverMessageSendScreen({
    Key? key,
  ...
  @override
  State<DriverMessageSendScreen> createState() =>
      _DriverMessageSendScreenState();
}

class _DriverMessageSendScreenState extends State<DriverMessageSendScreen> {
          ...
          title: Row(
            children: [
              ClipRRect(
                ...
                child: Container(
                    color: Colors.white,
                    child: widget.driverModel.profile_pic != ""
                        ? CachedNetworkImage(
                            imageUrl: widget.driverModel.profile_pic!,
                      ...
                      onTap: () async {
                        if (_messaging_controller.text.trim().isNotEmpty) {
                          if (Get.find<MessageSendController>()
                            ...
                            await ChatDetailFirebase().drivermessageDetail(
